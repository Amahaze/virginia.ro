          ...
          <Box className="block2-row">
            <Box className="info-box">
              <Box className="info-header">
                ...
                <Typography variant="h6" className="info-title">
                  {t('varex.block2.radiation.title')}
                </Typography>
              </Box>
              <Typography className="info-description">
                {t('varex.block2.radiation.description')}
              </Typography>
            </Box>
            ...
            <Box className="info-box">
              <Box className="info-header">
                ...
                <Typography variant="h6" className="info-title">
                  {t('varex.block2.reliability.title')}
                </Typography>
              </Box>
              <Typography className="info-description">
                {t('varex.block2.reliability.description')}
              </Typography>
            </Box>
          </Box>
          ...
          <Box className="block2-row">
            <Box className="info-box">
              <Box className="info-header">
                ...
                <Typography variant="h6" className="info-title">
                  {t('varex.block2.integration.title')}
                </Typography>
              </Box>
              <Typography className="info-description">
                {t('varex.block2.integration.description')}
              </Typography>
            </Box>
            ...
            <Box className="info-box">
              <Box className="info-header">
                ...
                <Typography variant="h6" className="info-title">
                  {t('varex.block2.compatibility.title')}
                </Typography>
              </Box>
              <Typography className="info-description">
                {t('varex.block2.compatibility.description')}
              </Typography>
            </Box>
          </Box>
        </Box>
