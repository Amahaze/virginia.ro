...
const Block3: React.FC = () => {
  ...
  return (
    <Box className="a-block3-section">
      <Box className="a-block3-container">
        <Typography variant="h2" className="a-block3-title">
          {t('airon.block3.title')}
        </Typography>
        <Box className="a-block3-grid">
          <Box className="a-block3-row-1">
            <Box className="a-info-box" ref={(el: HTMLDivElement | null): void => { infoBoxRefs.current[0] = el; }}>
              <PlayCircleOutlineIcon className="a-info-icon" />
