...
const ArticleDialog = ({ open, article, onClose, onSave }: ArticleDialogProps) => {
  ...
  const handleSave = async () => {
    try {
      ...
      formData.append('title_ro', title.ro);
      formData.append('title_en', title.en);
      formData.append('title_ru', title.ru);
      formData.append('content_ro', content.ro);
      formData.append('content_en', content.en);
      formData.append('content_ru', content.ru);
          ...
          {imageUrl && (
            <FormControl fullWidth disabled={saving}>
              ...
              <Select
                ...
                onChange={(e) => setImagePosition(e.target.value as 'left' | 'right' | 'top' | 'bottom')}
              >
